...
<body>
	<div id="container">
		...
		<section>
			<c:set var="path"
				value="${pageContext.request.servletContext.contextPath}/order" />
			<c:set var="cpath"
			...
			<table border="1" class="table table-striped table-hover">
				...
				<c:forEach var="order" items="${olist}">
					<tr onClick="location.href='${path}/orderDetail.go?order_code=${order.order_code}'" style="cursor:pointer;">
