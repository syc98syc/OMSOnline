...
<body>
	<div id="container">
		...
		<section>
			...
			<hr>
			<form
				action="${pageContext.request.servletContext.contextPath }/myorder/orderDetail.do"
				method="post">
				...
				<hr>
				<input type="submit" value="주문취소" class="btn btn-secondary">
			</form>
		</section>
		<%
